---
title: "Tuning LCDA-GRASP by Design of Experiments"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Tuning LCDA-GRASP by Design of Experiments}
...
continuous optimum lies*. We follow the sequential response-surface strategy
of [Box & Wilson, 1951]:
...
- **A modelling caveat** ("all models are wrong, some are useful"): on the small
